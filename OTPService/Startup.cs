...
using OTPService.Services.Implementation;
...
namespace OTPService
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "OTP service", Version = "v1" });
            ...
            services.AddScoped<IOTPService, OTPClient>();
            services.AddScoped<IOTPRepositoy, OTPRepositoy>();
        }
